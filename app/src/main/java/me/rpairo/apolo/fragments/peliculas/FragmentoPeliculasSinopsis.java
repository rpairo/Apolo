 ...
 */
public class FragmentoPeliculasSinopsis extends Fragment {
    ...
    public FragmentoPeliculasSinopsis() {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        sinopsiTextView.setText(ActivityDetallesPelicula.getPelicula().getDescripcion());
