...
public class FragmentoPeliculasProximas extends Fragment implements retrofit.Callback<ResponsePelicula>{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_peliculas_proximas, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.recycler = (RecyclerView) view.findViewById(R.id.recycler_peliculas_proximas);
