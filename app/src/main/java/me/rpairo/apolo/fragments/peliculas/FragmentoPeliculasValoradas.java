 ...
 */
public class FragmentoPeliculasValoradas extends Fragment implements retrofit.Callback<ResponsePeliculas>{
    ...
    public FragmentoPeliculasValoradas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_peliculas_valoradas, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.recycler = (RecyclerView) view.findViewById(R.id.recycler_peliculas_valoradas);
    ...
    private void request() {
        ApiAdapterPeliculas.getApiServicePeliculas()
                .getPeliculasMejorValoradas("es", ApiConstantsPeliculas.API_KEY, this);
    }
    //endregion
