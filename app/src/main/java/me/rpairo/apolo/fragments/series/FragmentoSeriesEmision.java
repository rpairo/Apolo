 ...
 */
public class FragmentoSeriesEmision extends Fragment implements retrofit.Callback<ResponseSeries> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_series_emision, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.recycler = (RecyclerView) view.findViewById(R.id.recycler_series_emision);
    ...
    private void request() {
        ApiAdapterTMDB.getApiServiceTMDB()
                .getSeriesEmision("es", ApiConstantsTMDB.API_KEY, this);
    }
    //endregion
